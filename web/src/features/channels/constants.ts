...
export const CHANNEL_TYPE_OPENAI_RESPONSE = 61
...
export const OPENAI_NATIVE_CHANNEL_TYPES = new Set([
  1,
  CHANNEL_TYPE_OPENAI_RESPONSE,
])
...
export const TYPE_TO_KEY_PROMPT: Record<number, string> = {
  ...
  [CHANNEL_TYPE_OPENAI_RESPONSE]: 'Enter API key for this channel',
}
