...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.POST("/ldc/notify", anonymousRequestBodyLimit, controller.LDCNotify)
		apiRouter.GET("/ldc/notify", controller.LDCNotify)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/ldc/pay", middleware.CriticalRateLimit(), controller.RequestLDC)
